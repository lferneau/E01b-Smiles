...
arcade.draw_ellipse_filled(face_x + 25, face_y + 25, 30, 65, open_color.black)
arcade.draw_ellipse_filled(face_x + -20, face_y + 25, 30, 65, open_color.black)
arcade.draw_circle_filled(face_x + 25, face_y + 40, 3, open_color.gray_2)
arcade.draw_circle_filled(face_x + -20, face_y + 40, 3, open_color.gray_2)
